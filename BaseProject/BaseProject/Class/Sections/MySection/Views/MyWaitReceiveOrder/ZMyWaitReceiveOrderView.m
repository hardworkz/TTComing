...
@interface ZMyWaitReceiveOrderView () <UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation ZMyWaitReceiveOrderView
#pragma mark - system

- (instancetype)initWithViewModel:(id<ZViewModelProtocol>)viewModel {
    
    self.viewModel = (ZMyWaitReceiveOrderViewModel *)viewModel;
