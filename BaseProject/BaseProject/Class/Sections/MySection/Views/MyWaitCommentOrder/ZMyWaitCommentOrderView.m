...
@interface ZMyWaitCommentOrderView () <UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation ZMyWaitCommentOrderView
#pragma mark - system

- (instancetype)initWithViewModel:(id<ZViewModelProtocol>)viewModel {
    
    self.viewModel = (ZMyWaitCommentOrderViewModel *)viewModel;
