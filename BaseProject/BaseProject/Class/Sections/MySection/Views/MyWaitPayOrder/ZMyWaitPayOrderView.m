...
@interface ZMyWaitPayOrderView () <UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation ZMyWaitPayOrderView
#pragma mark - system

- (instancetype)initWithViewModel:(id<ZViewModelProtocol>)viewModel {
    
    self.viewModel = (ZMyWaitPayOrderViewModel *)viewModel;
