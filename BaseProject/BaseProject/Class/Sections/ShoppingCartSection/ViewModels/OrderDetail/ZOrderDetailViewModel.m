...
@implementation ZOrderDetailViewModel
- (void)z_initialize {
    ...
    [self.refreshDataCommand.executionSignals.switchToLatest subscribeNext:^(NSDictionary *dict) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            ZOrderDetailCenterTableViewCellViewModel *viewModel = [[ZOrderDetailCenterTableViewCellViewModel alloc] init];
